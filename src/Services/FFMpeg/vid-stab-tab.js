...
export default class VidStabTab extends React.Component {
  ...
  stabilizeVideo = () => {
    ...
    let ffmpegCommand = VideoUtil.generateShakingVideoScript(
      image1Path,
      image2Path,
      image3Path,
      videoFile,
    ...
    executeFFmpegAsync(ffmpegCommand, completedExecution => {
      ffprint(`FFmpeg process exited with rc ${completedExecution.returnCode}.`)
  ...
  render() {
    return (
      <View style={styles.screenStyle}>
        ...
        <View
          style={[styles.buttonViewStyle, { paddingTop: 0, paddingBottom: 0 }]}
        >
          <TouchableOpacity
